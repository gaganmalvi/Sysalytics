...
# Battery
BATTERY_STATUS = ioutil.read_node("/sys/class/power_supply/BAT0/status")
BATTERY_CAPACITY = ioutil.read_node("/sys/class/power_supply/BAT0/capacity")
BATTERY_MODEL = ioutil.read_node("/sys/class/power_supply/BAT0/model_name")
